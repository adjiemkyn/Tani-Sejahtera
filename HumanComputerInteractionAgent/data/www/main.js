document.addEventListener('DOMContentLoaded', function () {
    ...
    var klienIdUnik = "TaniSejahtera.com-HumanComputerInteractionAgent-browser" + generateRandomString(5);
    ...
    client.onMessageArrived = function (message) {
        ...
        // Penangan pesan MCA        
        if (message.destinationName == "TaniSejahtera.com/MicroclimateConditionAgent") {
        ...
        //Penangan Pesan MAA
        if (message.destinationName == "TaniSejahtera.com/MicroclimateAdjusterAgent") {
            var data = JSON.parse(message.payloadString);
        ...
        //Penangan Pesan FRA
        if (message.destinationName == "TaniSejahtera.com/FertigationReservoirAgent") {
            var data = JSON.parse(message.payloadString);
        ...
        //Penangan Pesan FPA
        if (message.destinationName == "TaniSejahtera.com/FertigationPumpAgent") {
            var data = JSON.parse(message.payloadString);
